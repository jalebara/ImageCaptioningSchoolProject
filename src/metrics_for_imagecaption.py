...
def Calculate_metrics(reference, model_out):
  ...
  bleu_1 = sentenece_bleu(reference, model_out, weights=(1, 0, 0, 0))
  bleu_2 = sentenece_bleu(reference, model_out, weights=(0, 1, 0, 0))
  bleu_3 = sentenece_bleu(reference, model_out, weights=(0, 0, 1, 0))
  bleu_4 = sentenece_bleu(reference, model_out, weights=(0, 0, 0, 1))
  ...
  #from rouge import Rouge
  rouge = Rouge()
  rouge_score = rouge.get_scores(model_out, reference)
  ...
  to_return['bleu_1'] = bleu_1
  to_return['bleu_2'] = bleu_2
  to_return['bleu_3'] = bleu_3
  to_return['bleu_4'] = bleu_4
  to_return['rouge']= rouge_score
  to_return['meteor']= meteor_score
  return to_return
